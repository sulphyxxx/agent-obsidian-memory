...
- When the work is about global skills, memory infrastructure, or other cross-project agent tooling rather than the current repository, persist it under `--project-root "${CODEX_HOME:-$HOME/.codex}" --project-slug agent-memory-system`.
